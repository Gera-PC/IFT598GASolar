...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2019 at 09:38 PM
...
(34, 'Can add certificate', 12, 'add_certificate'),
(35, 'Can change certificate', 12, 'change_certificate'),
(36, 'Can delete certificate', 12, 'delete_certificate'),
(37, 'Can add client', 13, 'add_client'),
(38, 'Can change client', 13, 'change_client'),
(39, 'Can delete client', 13, 'delete_client'),
(40, 'Can add location', 14, 'add_location'),
(41, 'Can change location', 14, 'change_location'),
(42, 'Can delete location', 14, 'delete_location'),
(43, 'Can add performance date', 15, 'add_performancedate'),
(44, 'Can change performance date', 15, 'change_performancedate'),
(45, 'Can delete performance date', 15, 'delete_performancedate'),
(46, 'Can add product', 16, 'add_product'),
(47, 'Can change product', 16, 'change_product'),
(48, 'Can delete product', 16, 'delete_product'),
(49, 'Can add service', 17, 'add_service'),
(50, 'Can change service', 17, 'change_service'),
(51, 'Can delete service', 17, 'delete_service'),
(52, 'Can add test sequence', 18, 'add_testsequence'),
(53, 'Can change test sequence', 18, 'change_testsequence'),
(54, 'Can delete test sequence', 18, 'delete_testsequence'),
(55, 'Can add test standard', 19, 'add_teststandard'),
(56, 'Can change test standard', 19, 'change_teststandard'),
(57, 'Can delete test standard', 19, 'delete_teststandard'),
(58, 'Can add user', 20, 'add_user'),
(59, 'Can change user', 20, 'change_user'),
(60, 'Can delete user', 20, 'delete_user'),
(61, 'Can add performance data', 15, 'add_performancedata'),
(62, 'Can change performance data', 15, 'change_performancedata'),
(63, 'Can delete performance data', 15, 'delete_performancedata');
...
INSERT INTO `backend_certificate` (`id`, `report_number`, `issue_date`, `model_number_id`, `certificate_number`, `location_ID_id`, `standard_ID_id`, `userID_id`) VALUES
(1, '31540020', '03/12/2018', 'Solar-Strap', 'US 82180014', '0012', 'UL1703', 'jramirez'),
(2, '30973615', '02/12/2009', 'Eldora 270', 'PV72092751', '0013', 'IEC61215', 'mkhuntia');
...
(2, 'auth', 'permission'),
(4, 'auth', 'user'),
(12, 'backend', 'certificate'),
(13, 'backend', 'client'),
(14, 'backend', 'location'),
(15, 'backend', 'performancedata'),
(16, 'backend', 'product'),
(17, 'backend', 'service'),
(18, 'backend', 'testsequence'),
(19, 'backend', 'teststandard'),
(20, 'backend', 'user'),
...
(1, 'contenttypes', '0001_initial', '2019-04-18 18:23:53.868185'),
(2, 'auth', '0001_initial', '2019-04-18 18:24:06.248269'),
(3, 'admin', '0001_initial', '2019-04-18 18:24:08.382207'),
(4, 'admin', '0002_logentry_remove_auto_add', '2019-04-18 18:24:08.434285'),
(5, 'contenttypes', '0002_remove_content_type_name', '2019-04-18 18:24:09.691896'),
(6, 'auth', '0002_alter_permission_name_max_length', '2019-04-18 18:24:10.575199'),
(7, 'auth', '0003_alter_user_email_max_length', '2019-04-18 18:24:12.522967'),
(8, 'auth', '0004_alter_user_username_opts', '2019-04-18 18:24:12.799220'),
(9, 'auth', '0005_alter_user_last_login_null', '2019-04-18 18:24:13.533387'),
(10, 'auth', '0006_require_contenttypes_0002', '2019-04-18 18:24:13.557939'),
(11, 'auth', '0007_alter_validators_add_error_messages', '2019-04-18 18:24:13.768599'),
(12, 'auth', '0008_alter_user_username_max_length', '2019-04-18 18:24:14.438206'),
(13, 'auth', '0009_alter_user_last_name_max_length', '2019-04-18 18:24:15.161291'),
(14, 'backend', '0001_initial', '2019-04-18 18:24:32.469530'),
(15, 'sessions', '0001_initial', '2019-04-18 18:24:33.078706'),
(16, 'solarpv', '0001_initial', '2019-04-18 18:24:40.505689'),
(17, 'backend', '0002_auto_20190418_1952', '2019-04-18 18:53:04.518835'),
(18, 'backend', '0003_auto_20190418_1955', '2019-04-18 18:55:21.326766'),
(19, 'backend', '0004_auto_20190418_2025', '2019-04-18 19:26:03.458838'),
(20, 'backend', '0005_auto_20190418_2028', '2019-04-18 19:28:46.205426');
...
ALTER TABLE `backend_certificate`
  ...
  ADD KEY `backend_certificate_model_number_id_390ef8dc` (`model_number_id`);
...
ALTER TABLE `backend_performancedata`
  ADD PRIMARY KEY (`id`),
  ADD KEY `backend_performanced_model_number_id_64a12cfd_fk_backend_p` (`model_number_id`),
  ADD KEY `backend_performanced_sequence_ID_id_3d465d97_fk_backend_t` (`sequence_ID_id`);
...
--
ALTER TABLE `backend_performancedata`
  ADD CONSTRAINT `backend_performanced_model_number_id_64a12cfd_fk_backend_p` FOREIGN KEY (`model_number_id`) REFERENCES `backend_product` (`model_number`),
  ADD CONSTRAINT `backend_performanced_sequence_ID_id_3d465d97_fk_backend_t` FOREIGN KEY (`sequence_ID_id`) REFERENCES `backend_testsequence` (`sequence_ID`);
